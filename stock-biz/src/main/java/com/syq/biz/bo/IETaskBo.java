...
public class IETaskBo {
  ...
  public IETaskBo(int rowNum,String errorMsg) {
    this.rowNum = rowNum;
    this.errorMsg = errorMsg;
  }
  
  public IETaskBo(int num,String instructionNo,String taskName,String headerName,String headerIdCard,String groupUnit,Date beginTime,Date endTime, String country,String visitPurpose
    ...
    this.taskBeginTime = beginTime;
    this.taskEndTime = endTime;
    this.taskCountryName = country;
    this.visitPurpose = visitPurpose;
    this.costSource = costSource;
    this.instructionTime = instructionDate;
