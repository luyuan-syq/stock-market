						...
						_createColModel : function() {
							...
							var colModels = [ {
								...
								renderer : function(colValue, rowData, rowIndex) {
									var countNum = 0
									if (taskWaitAuditCount != null){
									  var taskCodeStr = rowData.taskCode;
									  if (taskCodeStr in taskWaitAuditCount){
										  countNum = taskWaitAuditCount[taskCodeStr];
										  if (countNum != 0){
											  countNum = '<font color="red">'+ countNum + '</font>'; 
										  }
									  }
									}
                                    return countNum;
							...
							var actionColModel = {
								...
								renderer : function(colValue, rowData, rowIndex) {
									...
									menu += "<div class='view' id='audit-task' type='view' name='"
										+ rowData.id + "'><a href='person/list?taskId="+rowData.id+"'>待审详情</a></div>";
