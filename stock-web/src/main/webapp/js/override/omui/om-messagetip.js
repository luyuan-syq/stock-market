...
(function( $, undefined ) {
    ...
    $.omMessageTip = {
        show: function(config){
            ...
            messageTip.close = function(disappearTime){
            	clearTimeout(timer);
            	$.omMessageTip._close(result, disappearTime);
            };
            
            return messageTip;
        },
        _close : function(result, disappearTime){
        	if(null != disappearTime) {
        		result.d.slideUp(disappearTime);
        	} else {
