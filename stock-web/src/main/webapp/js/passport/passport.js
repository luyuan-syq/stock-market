			...
			.extend(
					SYQ.Passport.prototype,
					{
						...
						_bindSearch : function() {
							var self = this;
							this.urls.getPassportURL = 'passport/ajaxList';
						...
						_buildGrid : function() {
							...
							return $el.omGrid({
								...
								dataSource : this.urls.getPassportURL,
						...
						_createColModel : function() {
							...
							var actionColModel = {
								...
								renderer : function(colValue, rowData, rowIndex) {
									...
									if(statusStr.indexOf("]"+rowIndex)>=0 || (statusStr.indexOf("_"+rowIndex)>=0 && statusStr.indexOf("["+rowIndex)>=0))
									{
									    menu += "<div class='edit' id='edit-account' type='edit' name='"
											 + rowData.id + "'><span onclick = '_buttonLoan(this)' value='" + rowData.passportNo + "'>借出</span></div>";
									}
									if(statusStr.indexOf("|"+rowIndex)>=0 ||(statusStr.indexOf("_"+rowIndex)>=0 && statusStr.indexOf("["+rowIndex)>=0))
									{
									    menu += "<div class='edit' id='edit-account' type='edit' name='"
						...
						_buildBtnBar : function() {
							...
							$('.buttonbar').omButtonbar({
								btns : [ {
									...
									id : "add-app",
									onClick : function() {
										window.location.href = that.ENGINE_CONTEXT_PATH + "passport/beforeImportPassports"
									},
									icons : {
							...
							$('.buttonbar').omButtonbar({
								btns : [ {
									...
									id : "add-app",
									onClick : function() {
										window.location.href = that.ENGINE_CONTEXT_PATH + "passport/download"
									},
									icons : {
										left : 'css/images/16/add.png'
									}
							...
							$('.buttonbar').omButtonbar({
								btns : [ {
									...
									id : "add-app",
									onClick : function() {
										window.location.href = that.ENGINE_CONTEXT_PATH + "download/passport.xlsx";
									},
									icons : {
										left : 'css/images/16/view.png'
									}
								}, {
									separtor : true
								} ]
