(function() {
	...
	// 为SYQ对象定义app方法
	SYQ.PassportStatus = function(options) {
		...
		this.$appAdd = $(".tab-app");
		this.passportStatusGrid = $(".passportStatus-grid");
		this.grid_limit = 10;
	...
	$
			.extend(
					SYQ.PassportStatus.prototype,
					{
						...
						_buildGrid : function() {
							var self = this;
							var $el = this.passportStatusGrid;
							return $el.omGrid({
								...
								dataSource : this.urls.getPassportStatusURL,
