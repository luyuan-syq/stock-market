(function() {
	...
	// 为SYQ对象定义app方法
	SYQ.PassportAudit = function(options) {
		...
		this.$appAdd = $(".tab-app");
		this.passportAuditGrid = $(".passportAudit-grid");
		this.grid_limit = 10;
					...
					SYQ.PassportAudit.prototype,
					{
						...
						_buildGrid : function() {
							...
							return $el.omGrid({
								...
								dataSource : this.urls.getPassportAuditURL,
							...
							var actionColModel = {
								...
								renderer : function(colValue, rowData, rowIndex) {
									var menu = "<div id='op-menu-" + rowIndex
											+ "' class='aps-op-menu'>";
									menu += "<div class='view' id='audit-apply-passport' type='view' name='"
										+ rowData.id + "'><a href='person/list?taskId="+rowData.taskId+"'>待审详情</a></div>";
									menu += "</div>";
									return menu
