...
<script type="text/javascript" src="js/passport/passportStatus.js"></script>
</head>
...
$(function() {
	...
	new SYQ.PassportStatus({
		namespace : '',
		ENGINE_CONTEXT_PATH : '',
		CONTEXT_PATH : '',
		urls : {
			getPassportStatusURL : 'person/ajaxList?taskId=${taskId}',
		}
	});
	...
	<div class="aps-ssomanager-container">
		<div class="aps-ssomanager-tabs">
			<ul>
				<li><a href="#status-passportList">办理状态查询</a></li>
			</ul>
			<div id="status-passportList">
				<div id="aps-console-app-view-wrap"
					...
					<div id="tab-app" class="tab-app">
						...
						<div class="grid">
							<table class="tb-grid passportStatus-grid"></table>
						</div>
