...
<script type="text/javascript" src="js/passport/passportLuru.js"></script>
</head>
...
$(function() {
	...
	new SYQ.PassportAudit({
		...
		CONTEXT_PATH : '',
		urls : {
			getPassportAuditURL : 'passport/auditAjaxList?status=0,1,2',
	...
	<div class="aps-ssomanager-container">
		<div class="aps-ssomanager-tabs">
			<ul>
				<li><a href="#luru-passportList">录入护照资料</a></li>
			</ul>
			<div id="luru-passportList">
