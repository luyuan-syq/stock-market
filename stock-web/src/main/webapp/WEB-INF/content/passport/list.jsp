...
<script type="text/javascript" src="js/passport/passport.js"></script>
</head>
...
$(function() {
	...
	passport = new SYQ.Passport({
		...
		urls : {
			...
			getPassportURL : 'passport/ajaxList',
				...
				<li><a href="#account-list">信息检索</a></li>--%>
				   			...
				   			<div>
					   			...
					   			<select id="searchStatus" class="input-text" style="height:25px">
					   			   <option value="4,5,101">所有</option>
					   			   <option value="4,101">借出</option>
					   			   <option value="5,101">归档</option>
					   			   <option value="4,5,100,101">将过期</option>
					   			</select>
