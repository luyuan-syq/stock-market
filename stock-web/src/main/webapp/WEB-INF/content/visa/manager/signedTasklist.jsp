...
<script type="text/javascript" src="js/visa/signedTasklist.js"></script>
</head>
...
$(function() {
	new SYQ.Task({
		...
		urls : {
			...
			getTaskURL : 'visa/signedTaskAjaxList',
	...
	<div class="aps-ssomanager-container">
		<div id="aps-task-tabs" class="aps-ssomanager-tabs">
			<ul>
				<li><a href="#task-list-search" class="account-listClass">已签管理</a></li>
				<%--
