...
<script type="text/javascript" src="js/visa/auditTasklist.js"></script>
</head>
...
$(function() {
	new SYQ.Task({
		...
		urls : {
			...
			getTaskURL : 'visa/ajaxListToVisa/?searchStatus=1',
	...
	<div class="aps-ssomanager-container">
		<div id="aps-task-tabs" class="aps-ssomanager-tabs">
			<ul>
				<li><a href="#task-list-search" class="account-listClass">待审签证</a></li>
				<%--
