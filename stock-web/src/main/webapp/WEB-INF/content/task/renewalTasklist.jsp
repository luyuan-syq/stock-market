...
<script type="text/javascript" src="js/task/renewalTask.js"></script>
</head>
...
$(function() {
	renewalTask = new SYQ.Task({
		...
		urls : {
			...
			getTaskURL : 'task/ajaxrenewalList?taskCode=${taskCode}',
	...
	<div class="aps-ssomanager-container">
		<div id="aps-task-tabs" class="aps-ssomanager-tabs">
			<ul>
				<li><a href="#task-list-search" class="account-listClass">换发查询</a></li>
				<%--
					    ...
					    <div id="search-panel">
				   			<div>
					   			...
					   			<select id="searchStatus" class="input-text" style="height:25px">
					   			   ...
					   			   <option value="4">护照换发函提交中</option>
					   			   <option value="5">换发函审核中</option>
					   			   <option value="6">复函已发出</option>
					   			   <option value="7">复函信息登记中</option>
					   			   <option value="8">换发完成</option>
